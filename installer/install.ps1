...
Write-Output "Downloading Aspose.Words 13.9.0 from NuGet"
.\NuGet.exe install Aspose.Words -Version 13.9.0 -ExcludeVersion -NoCache -NonInteractive -OutputDirectory .
