...
Write-Output "Downloading Aspose.Words 13.7.0 from NuGet"
.\NuGet.exe install Aspose.Words -Version 13.7.0 -ExcludeVersion -NoCache -NonInteractive -OutputDirectory .
