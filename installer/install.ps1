...
Write-Output "Downloading Aspose.Words 13.8.0 from NuGet"
.\NuGet.exe install Aspose.Words -Version 13.8.0 -ExcludeVersion -NoCache -NonInteractive -OutputDirectory .
