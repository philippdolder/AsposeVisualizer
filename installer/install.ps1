...
Write-Output "Downloading Aspose.Words 14.3.0 from NuGet"
.\NuGet.exe install Aspose.Words -Version 14.3.0 -ExcludeVersion -NoCache -NonInteractive -OutputDirectory .
