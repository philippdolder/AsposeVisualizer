// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CellProxyFacts.cs" company="Philipp Dolder">
//   Copyright (c) 2014
//
...
namespace AsposeVisualizer
{
    ...
    public class CellProxyFacts
    {
        private readonly CellProxy testee;
        ...
        [Fact]
        public void VisitsChildrenBetweenCellStartAndEnd()
        {
            ...
            using (var scope = Fake.CreateScope())
            {
                ...
                {
                    A.CallTo(() => visitor.VisitCellStart(this.testee)).MustHaveHappened();
                    A.CallTo(() => child.Accept(visitor)).MustHaveHappened();
                    A.CallTo(() => visitor.VisitCellEnd(this.testee)).MustHaveHappened();
                }
            }
        }
